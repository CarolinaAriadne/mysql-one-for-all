...
CREATE TABLE SpotifyClone.historico_reproducoes(
    ...
    CONSTRAINT PRIMARY KEY(usuario_id, id_musica) 
);
...
CONSTRAINT PRIMARY KEY(usuario_id, artista_id)
 ...
 INSERT INTO SpotifyClone.planos(nome_plano, valor_plano) VALUES
('gratuito', '0'),
('universitario', '5.99'),
('pessoal', '6.99'),
('familiar', '7.99');

INSERT INTO SpotifyClone.dados_usuario(nome_usuario,idade_usuario, id_plano, data_assinatura_plano) VALUES
...
INSERT INTO SpotifyClone.musicas(nome_musica, duracao_segundos, album_id) VALUES
('Soul For US', 200, 1),
...
INSERT INTO SpotifyClone.historico_reproducoes(id_musica, usuario_id, data_reproducao) VALUES
